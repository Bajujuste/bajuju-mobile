...
const styles = StyleSheet.create({
  ...
  roundButton: { position: 'relative', width: 49, height: 49, borderRadius: 25, alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.white, borderWidth: 1, borderColor: '#F7D7E7', shadowColor: '#8C124E', shadowOpacity: 0.1, shadowRadius: 10, shadowOffset: { width: 0, height: 5 }, elevation: 3 },
  ...
  profileButton: { height: 49, paddingHorizontal: 13, borderRadius: 25, flexDirection: 'row', alignItems: 'center', gap: 7, backgroundColor: COLORS.white, borderWidth: 1, borderColor: '#F7D7E7' },
  ...
  actionCard: { position: 'relative', flex: 1, height: 206, padding: 18, overflow: 'hidden', borderRadius: 29, borderWidth: 1.5, borderColor: COLORS.line, backgroundColor: COLORS.white, shadowColor: '#9B1A5B', shadowOpacity: 0.1, shadowRadius: 12, shadowOffset: { width: 0, height: 8 }, elevation: 3 },
  iconBlob: { width: 62, height: 62, borderRadius: 29, alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.softPink },
  ...
  nextExperienceArrow: { position: 'absolute', right: 15, top: 39, width: 38, height: 38, borderRadius: 19, backgroundColor: COLORS.white, alignItems: 'center', justifyContent: 'center' },
  infoCard: { marginTop: 20, padding: 22, borderRadius: 29, borderWidth: 1.5, borderColor: COLORS.line, backgroundColor: COLORS.white },
